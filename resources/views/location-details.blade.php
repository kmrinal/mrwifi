                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="router" aria-labelledby="router-tab" role="tabpanel">
                                        ...
                                        <div class="row col-12 mt-2">
                                            <div class="card">
                                <div class="card-header">
                                                    <h4 class="card-title">Network Interface Management</h4>
                                </div>
                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-4 col-12 match-height">
                                                            <div class="card shadow-none border">
                                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                                    <h5 class="mb-0">WAN Interface</h5>
                                                                    
                                                                </div>
                                                                <div class="card-body">
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">Connection Type:</span>
                                                                        <span class="font-weight-bold">DHCP</span>
                                                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">IP Address:</span>
                                                                        <span class="font-weight-bold">203.0.113.10</span>
                                                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">Gateway:</span>
                                                                        <span class="font-weight-bold">203.0.113.1</span>
                                                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">DNS:</span>
                                                                        <span class="font-weight-bold">8.8.8.8, 1.1.1.1</span>
                                                                    </div>
                                                                    <div class="d-flex justify-content-between">
                                                                        <span class="text-muted">Status:</span>
                                                                        <span class="font-weight-bold">Active</span>
                                                                    </div>
                                                                    <button class="btn btn-primary btn-block mt-2" data-toggle="modal" data-target="#wan-settings-modal">
                                                        ...
                                                        <div class="col-md-4 col-12 match-height">
                                                            <div class="card shadow-none border">
                                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                                    <h5 class="mb-0">Captive Portal</h5>
                                    </div>
                                                <div class="card-body">
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">IP Address:</span>
                                                                        <span class="font-weight-bold">192.168.100.1</span>
                                        </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">Netmask:</span>
                                                                        <span class="font-weight-bold">255.255.255.0</span>
                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">DHCP Server:</span>
                                                                        <span class="font-weight-bold">Enabled</span>
                                        </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">DHCP Range:</span>
                                                                        <span class="font-weight-bold">192.168.1.100 - 192.168.1.200</span>
                            </div>
                                                                    <div class="d-flex justify-content-between">
                                                                        <span class="text-muted">Status:</span>
                                                                        <span class="font-weight-bold">Active</span>
                                                                    ...
                                                                    <button class="btn btn-primary btn-block mt-2" data-toggle="modal" data-target="#lan-settings-modal">
                                                                        <i data-feather="edit" class="mr-50" style="width: 14px; height: 14px;"></i>Edit Captive Portal Settings
                                                                    </button>
                                                                    <p class="text-muted mt-1">Satic IP can only be used with Captive Portal</p>
                                                        ...
                                                        <div class="col-md-4 col-12 match-height">
                                                            <div class="card shadow-none border">
                                                                <div class="card-header d-flex justify-content-between align-items-center">
                                                                    <h5 class="mb-0">Password WiFi</h5>
                                                                    <span class="badge badge-light-primary" id="password-wifi-mode">Static IP</span>
                                                </div>
                                                <div class="card-body">
                                                            <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">IP Mode:</span>
                                                                        <span class="font-weight-bold" id="ip-mode-display">Static IP</span>
                                        </div>
                                                            <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">IP Address:</span>
                                                                        <span class="font-weight-bold">192.168.1.1</span>
                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1">
                                                                        <span class="text-muted">Netmask:</span>
                                                                        <span class="font-weight-bold">255.255.255.0</span>
                                </div>
                                                                    <div class="d-flex justify-content-between mb-1" id="dhcp-server-status-row">
                                                                        <span class="text-muted">DHCP Server:</span>
                                                                        <span class="font-weight-bold">Enabled</span>
                                                    </div>
                                                                    <div class="d-flex justify-content-between mb-1" id="dhcp-range-row">
                                                                        <span class="text-muted">DHCP Range:</span>
                                                                        <span class="font-weight-bold">192.168.1.100 - 192.168.1.200</span>
                                                </div>
                                                                    <div class="d-flex justify-content-between">
                                                                    ...
                                                                    <button class="btn btn-primary btn-block mt-2" data-toggle="modal" data-target="#password-network-modal">
                                                                        <i data-feather="edit" class="mr-50" style="width: 14px; height: 14px;"></i>Edit Password WiFi Network
                                                                    </button>
                                            </div>
                                        </div>
                                                    </div>
