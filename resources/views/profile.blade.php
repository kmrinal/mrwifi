...
<head>
    ...
    <meta name="description" content="Mr WiFi - User profile management for network administrators">
    <meta name="keywords" content="wifi, network, profile, dashboard, administrator, mr wifi">
    <meta name="author" content="Mr WiFi">
    <title>Profile - Mr WiFi</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="account-company" name="company" placeholder="Company name" value="Mr WiFi Networks" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-sm-6">
                                                        <div class="form-group">
